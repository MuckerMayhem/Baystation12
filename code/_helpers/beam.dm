...
/beam/var
	var/datum/lightning_vector/start
 ...
 */
/beam/New(datum/lightning_vector/source, datum/lightning_vector/dest, speed = 20, fade = 25)
		..()
 ...
 */
/beam/proc/Draw(z = 1, type = /obj/segmentBeam, color = "#fff", thickness = 1)

	src.thickness = thickness

	var/datum/lightning_vector/tangent  = vectorSubtract(end, start)
 ...
 */
/beam/proc/GetTurfs(z, accurate = 16)
