...
/BranchedBolt
	var/list/bolts
	var/datum/lightning_vector/end
 ...
 */
/BranchedBolt/New(datum/lightning_vector/start, datum/lightning_vector/end, fade = 50, targets=null)
	..()
 ...
 */
/BranchedBolt/proc/Draw(z, type = /obj/segment, color = "#fff", thickness = 1, split = 0)
 ...
 */
/BranchedBolt/proc/Create(datum/lightning_vector/start, datum/lightning_vector/end, targets = null)
	...
	for(var/i = 1 to positions.len)
		...
		var/datum/lightning_vector/boltStart = mainbolt.GetPoint(positions[i])

		var/datum/lightning_vector/boltEnd
		if(boltTargets)
			...
			var/datum/lightning_vector/v = vectorRotate(vectorMultiply(diff, 1 - positions[i]), pick(30,-30))
 ...
 */
/BranchedBolt/proc/GetTurfs(z, accurate = 16)
	var/bolt/b = bolts[1]
 ...
 */
/BranchedBolt/proc/GetAllTurfs(z, accurate = 16)
	var/list/locs = list()
