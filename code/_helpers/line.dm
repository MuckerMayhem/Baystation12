...
/line
	var/datum/lightning_vector/A
	var/datum/lightning_vector/B
 ...
 */
/line/proc/DrawOverlay(obj/root, obj/s, thickness = 1)
	var/datum/lightning_vector/tangent  = vectorSubtract(B, A)
 ...
 * @return an object or an image of given type transformed into a line between defined vectors
 */
/line/proc/Draw(z = 1, type = /obj/segment, color = "#fff", thickness = 1)
	var/datum/lightning_vector/tangent  = vectorSubtract(B, A)
	var/rotation        = Atan2(tangent.Y, tangent.X) - 90
 ...
 */
/line/proc/GetTurfs(z, accurate = 16)
 ...
 */
/line/proc/Rotate(angle)
	var/datum/lightning_vector/diff     = vectorSubtract(B, A)
	var/datum/lightning_vector/rotatedB = vectorRotate(diff, angle)
