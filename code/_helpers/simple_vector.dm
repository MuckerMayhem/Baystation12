 ...
 */
/datum/lightning_vector/New(x, y)
	..()
...
*/
/datum/lightning_vector/proc/Length()
...
*/
/datum/lightning_vector/proc/Locate(z)
...
*/
/datum/lightning_vector/proc/RoundVector(r = 1)
	X = round(X, r)
	Y = round(Y, r)
 ...
 */
/proc/isVector(v)
	return istype(v, /datum/lightning_vector)
 ...
 */
/proc/vectorAdd(datum/lightning_vector/v1, datum/lightning_vector/v2)
	return new /datum/lightning_vector (v1.X + v2.X, v1.Y + v2.Y)
/**
 ...
 */
/proc/vectorSubtract(datum/lightning_vector/v1, datum/lightning_vector/v2)
	return new/datum/lightning_vector(v1.X - v2.X, v1.Y - v2.Y)
 ...
 * @return new vector multiplied by number
	 */
/proc/vectorMultiply(datum/lightning_vector/v, num)
	return new/datum/lightning_vector(v.X * num, v.Y * num)
 ...
 */
/proc/vectorDistance(datum/lightning_vector/v1, datum/lightning_vector/v2)
 ...
 */
/proc/vectorNormalize(datum/lightning_vector/v)
	return new/datum/lightning_vector(v.X / v.Length(), v.Y / v.Length())
 ...
 */
/proc/vectorRotate(datum/lightning_vector/v, angle)
	return new/datum/lightning_vector(v.X * cos(angle) - v.Y * sin(angle), v.X * sin(angle) + v.Y * cos(angle))
 ...
 */
/proc/vectorGetTurfs(datum/lightning_vector/start, datum/lightning_vector/end, z, accurate = 16)
	var/list/locs
	var/distance    = vectorDistance(start, end)
	var/datum/lightning_vector/diff = vectorSubtract(end, start)
